...
`duh` is an audio toolkit. Pure Go, no cgo, nothing you didn't ask for.

It's a work in progress — not yet tagged, API still moving. This blog is where
release notes, design decisions, and the occasional rant will land.
